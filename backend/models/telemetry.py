...
class AgentExecutionLog(db.Model):
    ...
    user_id = db.Column(
        db.String(36),
        db.ForeignKey("users.id", name="fk_agentexecutionlog_user"),
        nullable=True,
        index=True,
    )
...
class TwinSimulationLog(db.Model):
    ...
    user_id = db.Column(
        db.String(36),
        db.ForeignKey("users.id", name="fk_twinsimulationlog_user"),
        nullable=True,
        index=True,
    )
...
class OrchestratorEvent(db.Model):
    ...
    user_id = db.Column(
        db.String(36),
        db.ForeignKey("users.id", name="fk_orchestratorevent_user"),
        nullable=True,
        index=True,
    )
    timestamp = db.Column(
