        ...
        "schedule": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "task": {
                        "type": "string",
                        "description": "Task title exactly as provided",
                    },
                    "start_time": {
                        "type": "string",
                    ...
                    "focus_block": {
                        "type": "boolean",
                        "description": "True if this requires deep uninterrupted focus",
                    },
                },
...
class PlanningAgent:
    ...
    def generate_plan(
        ...
        def _gemini_inference():
            ...
            logger.info(
                "Planning Agent (Gemini) generating schedule for %d tasks", len(tasks)
            )
        ...
        def _local_inference():
            ...
            preferred_hours = availability.get(
            ...
            start_hour, start_min = map(
                int, preferred_hours.get("start", "09:00").split(":")
            )
            ...
            end_bound = current_time.replace(
            ...
            for task in sorted_tasks:
                if (
                    ...
                    and float(task.get("priority_score", 0)) > 80
                ):
                    backlog.append(
                        {
                            "task_id": task.get("id"),
                ...
                while remaining_hrs > 0:
                    ...
                    if (
                        total_hours_assigned + chunk_hrs > daily_hours
                        or projected_end > end_bound
                    ):
                    ...
                    if (
                        current_time + break_duration <= end_bound and remaining_hrs > 0
                    ) or current_time < end_bound:
            ...
            planning_brief = [
                {
                    ...
                    "content": f"Optimized for {strategy} execution.",
                    "type": "optimization",
                }
            ]
            ...
            capacity_utilized = (
                (total_hours_assigned / daily_hours) * 100 if daily_hours > 0 else 0
            )
