...
PRIORITY_SCHEMA = {
    ...
    "properties": {
        "priority_score": {
            "type": "integer",
            "description": "0-100 score based on urgency and importance",
        },
        ...
        "reasoning": {
            "type": "string",
            "description": "Brief reasoning for the priority score",
        },
    },
    "required": [
        "priority_score",
...
class PriorityAgent:
    ...
    def analyze_task(
        self, task_data: Dict[str, Any], active_tasks_count: int = 0
    ) -> Dict[str, Any]:
        """
