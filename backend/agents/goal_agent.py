    ...
    def analyze_goal(self, title: str, description: str) -> Dict[str, Any]:
        ...
        def _gemini_inference():
            ...
            return self.gemini.generate_structured(
                prompt, f"{title} {description}", schema
            )
        ...
        def _local_inference():
            ...
            return {
                ...
                "milestones": matched_template
                or ["Define objective", "Break into sub-tasks", "Begin execution"],
