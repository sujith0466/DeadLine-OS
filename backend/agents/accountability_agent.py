    ...
    def _get_schema(self) -> dict:
        return {
            ...
            "properties": {
                "completion_rate": {
                    "type": "integer",
                    "description": "0-100 score of tasks completed vs total",
                },
                "consistency_score": {
                    "type": "integer",
                    "description": "0-100 score representing regular work habits",
                },
                "procrastination_score": {
                    "type": "integer",
                    "description": "0-100 score representing delay tendencies",
                },
                "productivity_score": {
                    "type": "integer",
                    "description": "0-100 aggregate metric",
                },
                "risk_profile": {
                    "type": "string",
                    "description": "A short phrase describing the user's risk (e.g., 'High Procrastination Risk')",
                },
                "key_findings": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "2-3 insights about their behavior",
                },
                "recommendations": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "2-3 actionable tips",
                },
            },
            "required": [
                "completion_rate",
